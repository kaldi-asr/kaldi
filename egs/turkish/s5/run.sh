...
for x in train test; do
 steps/make_mfcc.sh --nj 3 --cmd "$train_cmd" data/$x exp/make_mfcc/$x mfcc
 steps/compute_cmvn_stats.sh data/$x exp/make_mfcc/$x mfcc
done

### Mono
# Training
steps/train_mono.sh --nj 3 --cmd "$train_cmd" data/train data/lang exp/system1/mono
# Graph compilation  
utils/mkgraph.sh --mono data/lang exp/system1/mono exp/system1/mono/graph

# Decoding
steps/decode.sh --nj 3 --cmd "$train_cmd" exp/system1/mono/graph  data/test exp/system1/mono/decode_test
echo -e "Mono training done.\n"


### Triphone 
# Training
steps/align_si.sh --boost-silence 1.25 --nj 3 --cmd "$train_cmd" data/train data/lang exp/system1/mono exp/system1/mono_ali
...
# Decoding
steps/decode.sh --nj 3 --cmd "$train_cmd" exp/system1/tri1/graph  data/test exp/system1/tri1/decode_test

## Triphones + delta delta
# Training
steps/align_si.sh --nj 3 --cmd "$train_cmd" data/train data/lang exp/system1/tri1 exp/system1/tri1_ali
...
# Decoding
steps/decode.sh --nj 3 --cmd "$train_cmd" exp/system1/tri2a/graph  data/test exp/system1/tri2a/decode_test
echo -e "Triphone training done.\n"


### Triphone + LDA and MLLT
# Training
steps/align_si.sh --nj 3 --cmd "$train_cmd" data/train data/lang exp/system1/tri2a exp/system1/tri2a_ali
...
# Decoding
steps/decode.sh --nj 3 --cmd "$train_cmd" exp/system1/tri2b/graph  data/test exp/system1/tri2b/decode_test
echo -e "LDA+MLLT training done.\n"


### Triphone + LDA and MLLT + SAT and FMLLR
# Training
steps/align_si.sh --nj 3 --cmd "$train_cmd" --use-graphs true data/train data/lang exp/system1/tri2b exp/system1/tri2b_ali
...
# Decoding
steps/decode_fmllr.sh --nj 3 --cmd "$train_cmd" exp/system1/tri3b/graph  data/test exp/system1/tri3b/decode_test
# 
steps/align_fmllr.sh --nj 3 --cmd "$train_cmd" data/train data/lang exp/system1/tri3b exp/system1/tri3b_ali
echo -e "SAT+FMLLR training done.\n"


### Triphone + LDA and MLLT + SAT and FMLLR + fMMI and MMI
# Training
steps/make_denlats.sh --nj 3 --cmd "$train_cmd" --sub-split 10 --transform-dir exp/system1/tri3b_ali data/train data/lang exp/system1/tri3b exp/system1/tri3b_denlats || exit 1;
...
# Decoding
steps/decode.sh --nj 3 --cmd "$train_cmd" --transform-dir exp/system1/tri3b/decode_test exp/system1/tri3b/graph data/test exp/system1/tri3b_mmi_b0.1/decode_test

## UBM for fMMI experiments
# Training
steps/train_diag_ubm.sh --silence-weight 0.5 --nj 3 --cmd "$train_cmd" 600 data/train data/lang exp/system1/tri3b_ali exp/system1/dubm3b
...
for iter in 3 4 5 6 7 8; do
        steps/decode_fmmi.sh --nj 3 --cmd "$train_cmd" --iter $iter --transform-dir exp/system1/tri3b/decode_test  exp/system1/tri3b/graph data/test  exp/system1/tri3b_fmmi_a/decode_test_it$iter
done
...
# Decoding
for iter in 3 4 5 6 7 8; do
 steps/decode_fmmi.sh --nj 3 --cmd "$train_cmd" --iter $iter --transform-dir exp/system1/tri3b/decode_test  exp/system1/tri3b/graph data/test exp/system1/tri3b_fmmi_indirect/decode_test_it$iter
done
...
# Decoding
steps/decode_sgmm2.sh --nj 3 --cmd "$train_cmd" --transform-dir exp/system1/tri3b/decode_test exp/system1/sgmm2_5b2/graph data/test exp/system1/sgmm2_5b2/decode_test
# 
steps/align_sgmm2.sh --nj 3 --cmd "$train_cmd" --transform-dir exp/system1/tri3b_ali  --use-graphs true --use-gselect true data/train data/lang exp/system1/sgmm2_5b2 exp/system1/sgmm2_5b2_ali  || exit 1;

## Denlats
steps/make_denlats_sgmm2.sh --nj 3 --cmd "$train_cmd" --sub-split 10  --transform-dir exp/system1/tri3b_ali data/train data/lang exp/system1/sgmm2_5b2_ali exp/system1/sgmm2_5b2_denlats  || exit 1;
