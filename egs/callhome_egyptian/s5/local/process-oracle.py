...
oracleDir = "exp/sgmm2x_6a_mmi_b0.2/decode_dev_it4/oracle"
wordsFile = open('exp/sgmm2x_6a/graph/words.txt')
conversationList = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/dev')
oracleTmp = 'exp/sgmm2x_6a_mmi_b0.2/one-best/oracle-dev'
provFile = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/oracle.dev', 'w+')
