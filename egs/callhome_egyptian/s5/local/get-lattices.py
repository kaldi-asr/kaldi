...
latticeLocation = 'latjosh-sgmm/lattices-pushed/'

tmpdir = 'data/local/data/tmp/st/lattmp'
invalidplfdir = 'data/local/data/tmp/st/invalidplf'

conversationList = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/test')
provFile = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/st/asr.test.plf', 'w+')
invalidPLF = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/st/invalidPLF', 'w+')
blankPLF = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/st/blankPLF', 'w+')
rmLines = open('/export/a04/gkumar/corpora/fishcall/jack-splits/split-matt/st/removeLines', 'w+')
