...
parser.add_argument(
    "database_path1", help="Path to the downloaded (and extracted) madcat data"
)
parser.add_argument(
    "database_path2", help="Path to the downloaded (and extracted) madcat data"
)
parser.add_argument(
    "database_path3", help="Path to the downloaded (and extracted) madcat data"
)
parser.add_argument(
    "data_splits",
    help="Path to file that contains the train/test/dev split information",
)
parser.add_argument("out_dir", help="directory location to write output files.")
parser.add_argument(
    "images_scp_path",
