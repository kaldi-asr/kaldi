...
provides line segmentation and word segmentation information and also provide the writing 
condition (writing style, speed, carefulness) of the page. It is a large size dataset with 
42k page images and 600k line images and 305 writers. The major text is in Arabic but it 
also contains English letters and numerals. The dataset contains about 95k unique words and 
160 unique characters. The dataset has been used in NIST 2010 and 2013 
(Openhart Arabic large vocabulary unconstrained handwritten text recognition competition) evaluation 
for line level recognition task. 16.1% WER was obtained for line level recognition in that competition.
