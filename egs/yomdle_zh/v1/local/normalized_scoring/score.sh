...
OCR_SCORE=${script_dir}/../scripts/ocr_score.pl
...
python3 ${script_dir}/utils/normalize_spaces.py $HYP_FILE $OUTDIR/hyp.norm-sp.txt
...
# Step 4. Strip out Punctuation for altenative score
# TODO
