...
# 1f is as 1e except for l2 regularization: 0.037, 0.01 versus 0.03, 0.015
...
#WER dev (tgmed)      41.78     43.98     45.77     42.46     39.03
#WER dev (tglarge)      31.22     31.09     31.38     30.92     26.72
# Final train prob        -0.0464   -0.0450   -0.0636   -0.0485   -0.0535
# Final valid prob        -0.0739   -0.0771   -0.0792   -0.0746   -0.0784
# Final train prob (xent)   -1.5447   -1.5399   -2.8872   -1.5664   -1.6405
# Final valid prob (xent)   -1.7440   -1.7523   -2.9847   -1.7588   -1.8333
# Num-params                 4781712   3651216   3651216   3166080   3166080


#steps/info/nnet3_dir_info.pl exp/chain/tdnn1{a,b,c,d,e}_sp
#exp/chain/tdnn1a_sp: num-iters=120 nj=1..1 num-params=4.8M dim=40+100->1224 combine=-0.06->-0.05 (over 4)
#exp/chain/tdnn1b_sp: num-iters=120 nj=1..1 num-params=3.7M dim=40+100->1224 combine=-0.06->-0.05 (over 3)
#exp/chain/tdnn1c_sp: num-iters=120 nj=1..1 num-params=3.7M dim=40+100->1224 combine=-0.08->-0.06 (over 4)
...
if [ $stage -le 13 ]; then
  ...
  tdnn_opts="l2-regularize=0.037 dropout-proportion=0.0 dropout-per-dim-continuous=true"
  tdnnf_opts="l2-regularize=0.037 dropout-proportion=0.0 bypass-scale=0.66"
  linear_opts="l2-regularize=0.037 orthonormal-constraint=-1.0"
  prefinal_opts="l2-regularize=0.037"
