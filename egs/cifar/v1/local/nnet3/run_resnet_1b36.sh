...
# 1b36 is as 1b32 but using egs preprocessed with log(x+0.3), where
# x is the original brigthness between 0 and 1.
# It's maybe slightly better, but hard to be sure.

# local/nnet3/compare.sh exp/resnet1b32_cifar100 exp/resnet1b36_cifar100
# System                resnet1b32_cifar100 resnet1b36_cifar100
# final test accuracy:       0.6676      0.6699
# final train accuracy:       0.9174      0.9216
# final test objf:          -1.27745    -1.28357
# final train objf:        -0.291935   -0.282176
# num-parameters:            775140      775140

# local/nnet3/compare.sh exp/resnet1b32_cifar10 exp/resnet1b36_cifar10
# System                resnet1b32_cifar10 resnet1b36_cifar10
# final test accuracy:       0.9095      0.9111
# final train accuracy:        0.998      0.9968
# final test objf:         -0.327783   -0.340724
# final train objf:       -0.0139392  -0.0163059
