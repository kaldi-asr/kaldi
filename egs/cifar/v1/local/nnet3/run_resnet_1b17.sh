...
if [ $stage -le 2 ]; then
  ...
  steps/nnet3/train_raw_dnn.py --stage=$train_stage \
    --cmd="$train_cmd" \
    --image.augmentation-opts="--horizontal-flip-prob=0.5 --horizontal-shift=0.1 --vertical-shift=0.1 --num-channels=3 --color-shift=0.1 --color-scale=0.2 --brightness-shift=0.2 --brightness-scale=0.2" \
    --trainer.srand=$srand \
