...
# 1b16 is as 1b7, but adding --fill-mode=reflect.
#   Doesn't seem to help: 0.9111 -> 0.9101.
...
if [ $stage -le 2 ]; then
  ...
  steps/nnet3/train_raw_dnn.py --stage=$train_stage \
    --cmd="$train_cmd" \
    --image.augmentation-opts="--horizontal-flip-prob=0.5 --horizontal-shift=0.1 --vertical-shift=0.1 --num-channels=3 --fill-mode=reflect" \
    --trainer.srand=$srand \
