...
# 1b5 is an additional baseline for 1b4 but in the newly added layer,
#  changing the spacing from 2 to 1 which is a more normal configuration.
#
#  b4 and b5 are better than 1b, train acc goes from 0.9058 -> 0.9242 -> 0.9312
#                    test acc goes from 0.8507 -> 0.8705 -> 0.8745.
# (so we prefer this to 1b).
