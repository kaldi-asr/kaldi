...
# 1b9 is as 1b8 but removing one of the two res-blocks added in
#  7->8.  So it has one more res-block than 1b7, in the early
#  part of the network.
#    It's better: 7,8,9 test accuracy is 0.9111, 0.9087, 0.9132
#                     train accuracy is 0.9958, 0.9972, 0.9960.
#

# 1b8 is as 1b7 but adding two more res-blocks, with dimensions
# $nf1 and $nf2 (== 32 and 64).
