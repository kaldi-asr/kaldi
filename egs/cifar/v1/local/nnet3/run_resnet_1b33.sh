...
#   ... More relevant, it's like 1b32 but with 4 frames of padding.
...
#
# We're 0.3% worse on cifar10, 0.05% better on cifar-100.

# local/nnet3/compare.sh exp/resnet1b32_cifar10 exp/resnet1b33_cifar10
# System                resnet1b32_cifar10 resnet1b33_cifar10
# final test accuracy:       0.9095      0.9059
# final train accuracy:        0.998      0.9986
# final test objf:         -0.327783   -0.375307
# final train objf:       -0.0139392 -0.00766004
# num-parameters:            752010      752010
#
# local/nnet3/compare.sh exp/resnet1b32_cifar100 exp/resnet1b33_cifar100
# System                resnet1b32_cifar100 resnet1b33_cifar100
# final test accuracy:       0.6676       0.668
# final train accuracy:       0.9174      0.9474
# final test objf:          -1.27745    -1.33862
# final train objf:        -0.291935   -0.218253
