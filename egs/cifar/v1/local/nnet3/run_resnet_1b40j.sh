...
# 1bb0j is as 1b40i but smaller final learning rate by a factor of 2.
# It's worse:

# local/nnet3/compare.sh exp/resnet1b40e_cifar10 exp/resnet1b40i_cifar10 exp/resnet1b40j_cifar10
# System                resnet1b40e_cifar10 resnet1b40i_cifar10 resnet1b40j_cifar10
# final test accuracy:       0.9429      0.9446      0.9393
# final train accuracy:       0.9944      0.9968           1
# final test objf:         -0.177449   -0.176049   -0.193754
# final train objf:       -0.0263591  -0.0186943 -0.00651704
# num-parameters:            752010      752010      752010

# local/nnet3/compare.sh exp/resnet1b40e_cifar100 exp/resnet1b40i_cifar100 exp/resnet1b40j_cifar100
# System                resnet1b40e_cifar100 resnet1b40i_cifar100 resnet1b40j_cifar100
# final test accuracy:       0.7292      0.7371      0.7269
# final train accuracy:       0.8962      0.9158       0.954
# final test objf:         -0.969647   -0.937621    -0.99605
# final train objf:        -0.383473   -0.324718   -0.224079
