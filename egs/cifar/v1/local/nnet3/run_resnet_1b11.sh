...
# 1b11 is as 1b but using the "egs2" version of the egs,
# split into 2 not 3 archives, for speed.
#  It doesn't really make any difference in accuracy: final valid accuracy changes are:
#   1b -> 1b11, 0.9103 -> 0.9105.
