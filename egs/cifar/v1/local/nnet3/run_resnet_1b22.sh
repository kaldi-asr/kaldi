...
# 1b22 is as 1b19,20,21 but changing bypass-source to input.
# 1b21 is as 1b19,20 but changing bypass-source to noop (the default).
# 1b20 is as 1b19 but changing bypass-source from batchnorm to relu.
