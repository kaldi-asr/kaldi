...
# 1b18 is as 1b17 but increasing the perturbation values.
# seems worse: valid prob 0.9128 -> 0.9006, train 0.9926->0.9776.

# 1b17 is as 1b7 but adding extra augmentation options regarding
# color-space.
...
if [ $stage -le 2 ]; then
  ...
  steps/nnet3/train_raw_dnn.py --stage=$train_stage \
    --cmd="$train_cmd" \
    --image.augmentation-opts="--horizontal-flip-prob=0.5 --horizontal-shift=0.1 --vertical-shift=0.1 --num-channels=3 --color-shift=0.2 --color-scale=0.2 --brightness-shift=0.4 --brightness-scale=0.4" \
    --trainer.srand=$srand \
