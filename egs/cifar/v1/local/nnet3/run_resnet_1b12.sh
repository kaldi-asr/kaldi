...
# to 48.  Also see 1b15 where we add one more res-block at the start of
# this.
#   Valid accuracy is exacty the same as 1b7: 0.9111 -> 0.9111.
#   Test accuracy is better, of course: 0.9958 -> 0.9984.
