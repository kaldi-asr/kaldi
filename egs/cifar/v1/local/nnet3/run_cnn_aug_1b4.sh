...
#  It's no better: train 0.9164->0.9134, test 0.8632->0.8623.

# exp/cnn_aug_1b4_cifar10: num-iters=60 nj=1..2 num-params=1.7M dim=96->10 combine=-0.37->-0.35 loglike:train/valid[39,59,final]=(-0.35,-0.26,-0.26/-0.46,-0.40,-0.41) accuracy:train/valid[39,59,final]=(0.87,0.91,0.91/0.84,0.87,0.86)
...
if [ $stage -le 1 ]; then
  ...
  common2="use-spatial-averages=true required-time-offsets=0 height-offsets=-1,0,1 num-filters-out=48"
