...
# Test accuracy is similar to 40b (maybe a little worse), but
# train accuracy and train objf is better... this may indicate that
# the shrinkage scale is too small.

# local/nnet3/compare.sh exp/resnet1b32_cifar10 exp/resnet1b40b_cifar10 exp/resnet1b40c_cifar10
# System                resnet1b32_cifar10 resnet1b40b_cifar10 resnet1b40c_cifar10
# final test accuracy:       0.9095      0.9286      0.9266
# final train accuracy:        0.998      0.9894      0.9942
# final test objf:         -0.327783   -0.217376    -0.23229
# final train objf:       -0.0139392  -0.0374948  -0.0271758
# num-parameters:            752010      752010      752010

# local/nnet3/compare.sh exp/resnet1b32_cifar100 exp/resnet1b40b_cifar100 exp/resnet1b40c_cifar100
# System                resnet1b32_cifar100 resnet1b40b_cifar100 resnet1b40c_cifar100
# final test accuracy:       0.6676      0.6979       0.698
# final train accuracy:       0.9174        0.86      0.8906
# final test objf:          -1.27745     -1.0549    -1.06413
# final train objf:        -0.291935   -0.488048   -0.406009
