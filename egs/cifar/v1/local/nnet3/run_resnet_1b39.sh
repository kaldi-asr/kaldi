...
# 1b39 is as 1b32 but reducing the minibatch size from 256 to 128.
# This will affect how much randomization batch-norm gives us,
# so may have a regularizing effect.
# It does seem just fractionally better on test (and a little
# worse on train), so this is consistent with the idea that
# we're getting more regularization with smaller dropout
# minibatch size.

# local/nnet3/compare.sh exp/resnet1b32_cifar10 exp/resnet1b39_cifar10
# System                resnet1b32_cifar10 resnet1b39_cifar10
# final test accuracy:       0.9095       0.911
# final train accuracy:        0.998      0.9964
# final test objf:         -0.327783   -0.326299
# final train objf:       -0.0139392  -0.0177655
# num-parameters:            752010      752010


# local/nnet3/compare.sh exp/resnet1b32_cifar100 exp/resnet1b39_cifar100
# System                resnet1b32_cifar100 resnet1b39_cifar100
# final test accuracy:       0.6676      0.6701
# final train accuracy:       0.9174      0.9108
# final test objf:          -1.27745    -1.26767
# final train objf:        -0.291935   -0.308839
