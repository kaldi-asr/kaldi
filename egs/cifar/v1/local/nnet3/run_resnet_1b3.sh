...
#  seems to train more completely, on final iter train objf changes 0.9948->0.999,
#  but test error degrades slightly 0.9146 ->0.909.

#  maybe we have too many params now...
