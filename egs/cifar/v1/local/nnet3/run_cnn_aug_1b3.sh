...
# fewer filters in the higher layers (64->48).  It's better:
#  train 0.8978->0.9164,  valid 0.844->0.8632.
# exp/cnn_aug_1b3_cifar10: num-iters=60 nj=1..2 num-params=1.7M dim=96->10 combine=-0.36->-0.35 loglike:train/valid[39,59,final]=(-0.34,-0.24,-0.25/-0.45,-0.40,-0.40) accuracy:train/valid[39,59,final]=(0.88,0.92,0.92/0.85,0.87,0.86)
