...
# No, use 1b32 as the better baseline, it uses the "egs2" egs where there
# are the same number of archives as here.
#
# It's about the same on cifar-10, slightly worse on cifar-100. Note:
# 32 is the closer baseline, usign that.

# local/nnet3/compare.sh exp/resnet1b32_cifar10 exp/resnet1b30_cifar10
# System                resnet1b32_cifar10 resnet1b30_cifar10
# final test accuracy:       0.9095      0.9093
# final train accuracy:        0.998      0.9968
# final test objf:         -0.327783   -0.355272
# final train objf:       -0.0139392  -0.0166483
# num-parameters:            752010      752010

# local/nnet3/compare.sh exp/resnet1b32_cifar100 exp/resnet1b30_cifar100
# System                resnet1b32_cifar100 resnet1b30_cifar100
# final test accuracy:       0.6676      0.6585
# final train accuracy:       0.9174      0.9182
# final test objf:          -1.27745    -1.34408
# final train objf:        -0.291935   -0.293492
