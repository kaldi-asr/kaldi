...
# 1b40g is as 1b40d but reducing the final learning rate by a factor of 10.
# not helpful.
...
# local/nnet3/compare.sh exp/resnet1b40d_cifar100 exp/resnet1b40g_cifar100
# System                resnet1b40d_cifar100 resnet1b40g_cifar100
# final test accuracy:       0.7207      0.6897
# final train accuracy:       0.9576      0.9734
# final test objf:          -1.03634    -1.15117
# final train objf:        -0.201047   -0.173118
# num-parameters:            775140      775140

# local/nnet3/compare.sh exp/resnet1b40d_cifar10 exp/resnet1b40g_cifar10
# System                resnet1b40d_cifar10 resnet1b40g_cifar10
# final test accuracy:       0.9379      0.9261
# final train accuracy:            1      0.9998
# final test objf:          -0.20726    -0.25817
# final train objf:      -0.00622737 -0.00596229
