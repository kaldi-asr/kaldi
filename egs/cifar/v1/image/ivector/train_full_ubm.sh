...
# for a specified number of iterations.  This is for images, and the features
# are specialized for that.
...
for f in $data/images.scp $srcdir/final.mat $srcdir/patch_opts; do
   [ ! -f $f ] && echo "$0: expecting file $f to exist" && exit 1
done

patch_opts=$(cat $srcdir/patch_opts)
[ ! -f $dir/patch_opts ] && cp $srcdir/patch_opts $dir/
[ ! -f $dir/final.mat ] && cp $srcdir/final.mat $dir/
