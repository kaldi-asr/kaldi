...
if [ $# != 3 ]; then
   echo "Usage: scripts/decode_tri2g_diag_fmllr.sh <graph> <decode-dir> <job-number>"
   exit 1;
fi
...
feats="ark:add-deltas --print-args=false scp:$scp ark:- | transform-feats $utt2spk_opt ark:$dir/$job.lvtln_trans ark:- ark:- |"
...
feats="ark:add-deltas --print-args=false scp:$scp ark:- | transform-feats $utt2spk_opt ark:$dir/$job.lvtln_trans ark:- ark:- | transform-feats $utt2spk_opt ark:$dir/$job.fmllr_trans ark:- ark:- |"
