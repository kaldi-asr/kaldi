...
# sgmm2e is as sgmm2b but on splice+LDA+ET features, not delta+accel
...
dir=exp/sgmm2e
srcdir=exp/tri2k # note: script knows that transforms are $srcdir/14.*.trans
mat=$srcdir/lda.mat
ubm=exp/ubm2d/final.ubm
