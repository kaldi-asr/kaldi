...
# tri2h is splice-9-frames + HLDA
#
# See tri3h for a full-size (si-284) system that builds from this.
...
feats="ark,s,cs:splice-feats --print-args=false scp:$dir/train.scp ark:- | transform-feats $dir/cur.mat ark:- ark:- |"
for n in 1 2 3; do
   ...
   featspart[$n]="ark,s,cs:splice-feats --print-args=false scp:$dir/train${n}.scp ark:- | transform-feats $dir/cur.mat ark:- ark:- |"
done
