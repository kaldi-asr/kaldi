...
mix_up=0 # Number of components to mix up to (should be > #tree leaves, if
        # specified.)
num_threads=16
parallel_opts="--num-threads 16 -l ram_free=1G,mem_free=1G"
...
if [ $# != 4 ]; then
  ...
  echo "  --parallel-opts <opts|\"--num-threads 16 -l ram_free=1G,mem_free=1G\">      # extra options to pass to e.g. queue.pl for processes that"
