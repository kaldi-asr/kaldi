...
# train_maxout_accel2.sh is modified from train_pnorm_accel2.sh
# 2015 Xingyu Na
...
bias_stddev=0.5
maxout_input_dim=3000 
maxout_output_dim=300
...
if [ $stage -le -2 ]; then
  ...
  stddev=`perl -e "print 1.0/sqrt($maxout_input_dim);"`
...
AffineComponentPreconditionedOnline input-dim=$lda_dim output-dim=$maxout_input_dim $online_preconditioning_opts learning-rate=$initial_lrate param-stddev=$stddev bias-stddev=$bias_stddev
MaxoutComponent input-dim=$maxout_input_dim output-dim=$maxout_output_dim
NormalizeComponent dim=$maxout_output_dim
AffineComponentPreconditionedOnline input-dim=$maxout_output_dim output-dim=$num_leaves $online_preconditioning_opts learning-rate=$initial_lrate param-stddev=0 bias-stddev=0
...
AffineComponentPreconditionedOnline input-dim=$maxout_output_dim output-dim=$maxout_input_dim $online_preconditioning_opts learning-rate=$initial_lrate param-stddev=$stddev bias-stddev=$bias_stddev
MaxoutComponent input-dim=$maxout_input_dim output-dim=$maxout_output_dim
NormalizeComponent dim=$maxout_output_dim
EOF
...
if [ $stage -le $num_iters ]; then
  ...
  # maxout layer and then a normalize layer.
