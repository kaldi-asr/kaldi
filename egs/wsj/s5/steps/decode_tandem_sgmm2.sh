...
if [ $# -ne 4 ]; then
  echo "Usage: steps/decode_tandem_sgmm2.sh [options] <graph-dir> <data-dir1> <data-dir2> <decode-dir>"
  echo " e.g.: steps/decode_tandem_sgmm2.sh --transform-dir exp/tri3b/decode_dev93_tgpr \\"
