...
if [ $# != 5 ]; then
  echo "Usage: steps/train_nnet_cpu_parallel11.sh <data> <lang> <ali-dir> <exp-dir> <num-leaves>"
  echo " e.g.: steps/train_nnet_cpu_parallel11.sh data/train_si84 data/lang exp/tri3b_ali exp/tri4y36_nnet 2500"
  echo ""
