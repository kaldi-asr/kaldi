...
def GetArgs():
    parser = argparse.ArgumentParser(description = "Accumulate statistics from lattice-alignment"
    ...
    parser.add_argument("phone_map", metavar = "<phone-map>", type = str,
                        help = "The phone map used to remove word boundary markers from phones;"
