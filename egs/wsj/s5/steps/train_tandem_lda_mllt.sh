...
if [ $# != 7 ]; then
  echo "Usage: steps/train_tandem_lda_mllt.sh [options] <#leaves> <#gauss> <data1> <data2> <lang> <alignments> <dir>"
  echo " e.g.: steps/train_tandem_lda_mllt.sh 2500 15000 {mfcc,bottleneck}/data/train_si84 data/lang exp/tri1_ali_si84 exp/tri2b"
...
splicedfeats="ark,s,cs:paste-feats '$feats1' '$feats2' ark:- |"
...
# Begin training;  estimate LDA first
if [ $stage -le -4 ]; then
