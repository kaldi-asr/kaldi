...
if [ $# -ne 4 ]; then
  echo "Usage: steps/decode_tandem_sgmm.sh [options] <graph-dir> <data1-dir> <data2-dir> <decode-dir>"
  echo " e.g.: steps/decode_tandem_sgmm.sh --transform-dir exp/tri3b/decode_dev93_tgpr \\"
