...
if [ $# != 5 ]; then
   echo "usage: steps/align_tandem_fmllr.sh <data1-dir> <data2-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  steps/align_fmllr.sh {mfcc,bottleneck}/data/train data/lang exp/tri1 exp/tri1_ali"
