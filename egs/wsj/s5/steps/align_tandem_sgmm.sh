...
if [ $# != 5 ]; then
   echo "usage: steps/align_tandem_sgmm.sh <data1-dir> <data2-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  steps/align_tandem_sgmm.sh --transform-dir exp/tri3b data1/train data1/lang \\"
