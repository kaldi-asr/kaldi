...
def get_args():
    ...
    args.min_states_silence = int(
        old_div(args.min_silence_duration, args.frame_shift) + 0.5
    )
    args.min_states_speech = int(
        old_div(args.min_speech_duration, args.frame_shift) + 0.5
    )
    args.max_states_speech = int(
        old_div(args.max_speech_duration, args.frame_shift) + 0.5
    )
