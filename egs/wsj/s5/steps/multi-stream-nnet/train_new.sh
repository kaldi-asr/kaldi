...
if [ $# != 7 ]; then
   echo "Usage: $0 <data-train> <data-dev> <lang-dir> <ali-train> <ali-dev> <stream-indices> <exp-dir>"
   echo " e.g.: $0 data/train data/cv data/lang exp/mono_ali_train exp/mono_ali_cv 0:84:168:252:336:420 exp/mono_nnet"
   echo ""
