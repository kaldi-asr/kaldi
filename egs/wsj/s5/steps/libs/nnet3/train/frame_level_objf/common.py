...
def train_new_models(dir, iter, srand, num_jobs,
                     ...
                     momentum,
                     adversarial_training_scale, adversarial_training_prob,
                     max_param_change,
    ...
    for job in range(1, num_jobs+1):
        ...
        process_handle = common_lib.run_job(
            """{command} {train_queue_opt} {dir}/log/train.{iter}.{job}.log \
                    ...
                    --adversarial-training-prob={adversarial_training_prob} \
            ...
            """--discard-partial-minibatches=true ark:- ark:- |" \
                    {dir}/{next_iter}.{job}.raw""".format(
                        ...
                        adversarial_training_prob=adversarial_training_prob,
