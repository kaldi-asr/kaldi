...
if [ $stage -le 0 ]; then
  ...
  $cmd --num-threads 8 JOB=1:$nj $dir/log/extract_ivectors.JOB.log \
     ivector-extract-online2 --config=$ieconf --num-threads=8 ark:$sdata/JOB/spk2utt scp:$sdata/JOB/feats.scp ark:- \| \
