...
def AddLstmLayer(config_lines,
    ...
    if add_recurrent_projection and add_non_recurrent_projection:
        ...
        #components.append("# Output : Wyr and Wyp")
        #components.append("component name={0}_Wy- type=NaturalGradientAffineComponent input-dim={1} output-dim={2}".format(name, recurrent_projection_dim + non_recurrent_projection_dim, output_dim))
        ...
        #components.append("# Output : Wyr")
        #components.append("component name={0}_Wyr type=NaturalGradientAffineComponent input-dim={1} output-dim={2}".format(name, recurrent_projection_dim, output_dim))
    #else:
        #components.append("# Output : Wym")
        #components.append("component name={0}_Wym type=NaturalGradientAffineComponent input-dim={1} output-dim={2}".format(name, cell_dim, output_dim))
    ...
    if (add_recurrent_projection and add_non_recurrent_projection):
        ...
        #component_nodes.append("# Splitting outputs of Wy- node")
        ...
        #component_nodes.append("# y_t")
        #component_nodes.append("component-node name={0}_y_t component={0}_Wy- input={0}_rp_t".format(name))
    elif add_recurrent_projection:
        ...
        #component_nodes.append("# y_t")
        #component_nodes.append("component-node name={0}_y_t component={0}_Wyr input={0}_r_t".format(name))
    else:
        output_descriptor = '{0}_m_t'.format(name)
        #component_nodes.append("# y_t")
        #component_nodes.append("component-node name={0}_y_t component={0}_Wym input={0}_m_t".format(name))
