...
feat_type=        # If supplied, the raw egs will generated by feat with 'delta', 'lda'
...
splice_opts="--left_context=1 --right_context=1"
case $feat_type in
  delta) feats="$feats add-deltas $delta_opts ark:- ark:- |";;
  lda) feats="$feats splice-feats $splice_opts ark:- ark:- |";;
  *) feats="$feats";;
esac
