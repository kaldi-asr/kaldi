...
feat-to-len scp:$data/feats.scp ark,t:-| \
  awk -v min_len=$frames_per_eg '{if ($2 >= min_len) print $1}' | \
...
feat-to-len scp:$data/feats.scp ark,t:-| awk -v min_len=$frames_per_eg '{if ($2 >= min_len) print $1}' | utils/filter_scp.pl --exclude $dir/valid_uttlist | \
