...
def train(args, run_opts):
    ...
    egs_left_context_initial = (
        left_context_initial + old_div(args.frame_subsampling_factor, 2)
        if left_context_initial >= 0
        else -1
    )
    egs_right_context_final = (
        right_context_final + old_div(args.frame_subsampling_factor, 2)
    ...
    for iter in range(num_iters):
        ...
        epoch = old_div(
            num_archives_processed * args.num_epochs, num_archives_to_process
        )
