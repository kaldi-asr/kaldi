...
chain_lib = imp.load.source('', 'nnet3_chain_lib.py')
...
def GetArgs():
    ...
    parser.add_argument("--chain.l2-regularize", type=float, dest='l2_regularize',
                        ...
                        without the log-softmax layer for the outputs. As l2-norm
                        of the log-softmax outputs can dominate the objective 
                        function. """)
    ...
    parser.add_argument("--chain.frame-subsampling-factor", type=int,
                        ...
                        default = 3, help="controls reduced frame-rate at the output")
...
{command} {train_queue_opt} {dir}/log/train.{iter}.{job}.log \
  ...
  --xent-regularize={xent_reg} {deriv_time_opts} \
...
def TrainOneIteration(dir, iter, egs_dir,
    ...
    chain_lib.ComputeTrainCvProbabilities(dir, iter, egs_dir, run_opts)
...
def Train(args, run_opts):
    ...
    # Set some variables.
    num_jobs = GetNumberOfJobs(args.tree_dir)
    ...
    if (args.stage <= -7):
        ...
        CreatePhoneLm(args.dir, args.tree_dir, run_opts, lm_opts = args.lm_opts)

    if (args.stage <= -6):
        logger.info("Creating denominator FST")
        CreateDenominatorFst(args.dir, args.tree_dir, run_opts)

    num_leaves = GetNumberOfLeaves(args.tree_dir)
    if (args.stage <= -4):
...
{command} {dir}/log/nnet_init.log \
    ...
    if (args.stage <= -3) and args.egs_dir is None:
        ...
        chain_lib.GenerateChainEgs(dir, args.feat_dir, args.lat_dir, default_egs_dir,
        ...
        if args.stage <= iter:
            ...
            if args.email is not None:
                ...
                # lets do some reporting
                    [report, times, data] = nnet3_log_parse.ParseLogs(args.dir, "log-probability")
                    message = report
    ...
    if args.stage <= num_iters:
        ...
        chain_lib.CombineModels(args.dir, num_iters, num_iters_combine, args.chunk_width,
                                egs_dir, run_opts)
