...
{command} {dir}/log/nnet_init.log \
    ...
    [egs_left_context, egs_right_context, frames_per_eg, num_archives] = train_lib.VerifyEgsDir(egs_dir, feat_dim, ivector_dim, left_context, right_context, args.ivector_interval)
