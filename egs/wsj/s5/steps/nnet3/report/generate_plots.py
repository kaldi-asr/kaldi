...
"""
    ...
    def compile(self):
        ...
        try:
            ...
            logger.warning("There was an error compiling latex file {0}. "
                           "Check report.log generated by pdflatex in the same directory. "
                           "{1}".format(latex_file, e))
            return False
        return True
...
def generate_clipped_proportion_plots(exp_dir, output_dir, plot,
    ...
    try:
        ...
        logger.warning("The main experiment directory %s does not have "
                       "clipped proportions. So not generating clipped "
                       "proportion plots.", exp_dir)
        return
