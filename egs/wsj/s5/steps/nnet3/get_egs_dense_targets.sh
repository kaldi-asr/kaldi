...
if [ $stage -le 2 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    nnet3-get-egs-dense-targets --num-targets=$num_targets $valid_ivector_opt $egs_opts "$valid_feats" \
    "scp:utils/filter_scp.pl $dir/valid_uttlist $targets_scp |" \
    "ark:$dir/valid_all.egs" || touch $dir/.error &
  $cmd $dir/log/create_train_subset.log \
    nnet3-get-egs-dense-targets --num-targets=$num_targets $train_subset_ivector_opt $egs_opts "$train_subset_feats" \
  ...
  rm -f $dir/valid_all.egs $dir/train_subset_all.egs $dir/{train,valid}_combine.egs $dir/ali_special.gz
fi
...
if [ $stage -le 3 ]; then
  ...
  $cmd $io_opts JOB=1:$nj $dir/log/get_egs.JOB.log \
    nnet3-get-egs-dense-targets --num-targets=$num_targets $ivector_opt $egs_opts --num-frames=$frames_per_eg "$feats" \
