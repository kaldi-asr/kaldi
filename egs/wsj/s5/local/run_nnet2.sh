...
if $use_gpu; then
  ...
  local/nnet2/run_5d_gpu.sh # this is p-norm training on top of fMLLR features.  <THIS IS THE MAIN RECIPE>
  ...
  local/nnet2/run_5d.sh # this is p-norm on top of fMLLR features.  <THIS IS THE MAIN RECIPE>
fi
