...
dir=exp/nnet3/blstm${affix:+_$affix}${use_delay:+_ld$label_delay}
...
if [ $stage -le 8 ]; then
  ...
  steps/nnet3/blstm/train.sh --stage $train_stage \
...
if [ $stage -le 9 ]; then
  ...
  for lm_suffix in tgpr bd_tgpr; do
    ...
    for year in eval92 dev93; do
      ...
      steps/nnet3/blstm/decode.sh --nj $num_jobs --cmd "$decode_cmd" \
