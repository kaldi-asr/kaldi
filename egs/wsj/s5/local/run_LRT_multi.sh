...
if [ "$gmm" == "true" ]; then
  ...
  utils/mkgraph.sh data/lang_test_bd_tgpr $dir/virtual $dir/virtual/graph_bd_tgp:
...
nnet3dir=${dir}_tdnn_multi

./local/nnet3/run_tdnn_multi.sh --dir $nnet3dir $dir $dir/virtual $num_trees -100
