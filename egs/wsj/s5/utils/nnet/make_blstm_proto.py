...
print "<Tanh> <InputDim> %d <OutputDim> %d" % (2*o.proj_dim, 2*o.proj_dim)

# Softmax layer,
print "<AffineTransform> <InputDim> %d <OutputDim> %d <BiasMean> 0.0 <BiasRange> 0.0" % (2*o.proj_dim, num_leaves) + softmax_affine_opts
