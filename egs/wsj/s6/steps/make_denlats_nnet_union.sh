...
###
### We will produce lattice where we paste-in the correct path, using lattice-union
###

# The transcription
tra="ark:utils/sym2int.pl --map-oov $oov -f 2- $lang/words.txt $sdata/JOB/text|";
scale_opts="--self-loop-scale=0.1 --transition-scale=1.0"

echo "Generating the numerator ali and lattices with LM scores (to be unioned with den-lattice)"
