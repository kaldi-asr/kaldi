...
if [ $# != 3 ]; then
   ...
   echo ""
   echo "This script works on CMN+LDA+MLLT features; it works out"
...
for f in $sdata/1/feats.scp $sdata/1/cmvn.scp $model $graphdir/HCLG.fst $graphdir/words.txt $srcdir/final.mat; do
