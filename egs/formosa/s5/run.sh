...
# Instruction
#
# Before you run this recips, please apply, download and put or make a link of the corpus under this folder (folder name: "NER-Trs-Vol1"). for more detail, please check:
...
#
# you should adjust these numbers according to your machines
#
