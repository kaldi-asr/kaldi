...
if [ $stage -le 23 ]; then
  ...
  utils/lang/check_phones_compatible.sh \
    data/lang_test_tg/phones.txt $lang/phones.txt
  utils/mkgraph.sh \
    --self-loop-scale 1.0 data/lang_test_tg \
    $tree_dir $tree_dir/graph_tg || exit 1;

  utils/lang/check_phones_compatible.sh \
    data/lang_test_fg/phones.txt $lang/phones.txt
  utils/mkgraph.sh \
    --self-loop-scale 1.0 data/lang_test_fg\
    $tree_dir $tree_dir/graph_fg || exit 1;
fi
