...
%eval92_clean(40min)
post_from_lats_lex_word_tg=fopen('/export/a07/jyang/kaldi_harish/egs/aurora4_jinyi/s5/post_on_lattice_nnet1_multi/eval92_noise_street/eval92_noise_street.post.matrix');
post_from_lats_lex_phone_bg=fopen('/export/a07/jyang/kaldi_harish/egs/aurora4_jinyi/s5/post_on_lattice_nnet1_multi_phone_lex_bg_dep/eval92_noise_street/eval92_noise_street.post.matrix');
post_from_nnet1=fopen('/export/a07/jyang/kaldi_harish/egs/aurora4_jinyi/s5/post_from_nnet1_multi/test_eval92_noise_harish_street/monophone_bnfea_test_eval92_noise_street.all.matrix');


P=post_from_lats_lex_word_tg;
...
xlabel('Time/s');
savefig('KL_street_tg_nnet.fig');
%saveas(h,'KL_street_tg_nnet','jpg');
