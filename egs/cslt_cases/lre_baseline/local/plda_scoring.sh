...
if [ "$use_existing_models" == "true" ]; then
  ...
  run.pl $plda_vec_dir/log/plda.log \
    ivector-compute-plda "ark:utils/utt2spk_to_spk2utt.pl $plda_data_dir/utt2lang|" \
...
run.pl $scores_dir/log/plda_scoring.log \
  ivector-plda-scoring --normalize-length=true \
    ...
    "ark:ivector-subtract-global-mean ${plda_vec_dir}/mean.vec scp:${enroll_vec_dir}/lang_vector.scp ark:- | ivector-normalize-length ark:- ark:- |" \
