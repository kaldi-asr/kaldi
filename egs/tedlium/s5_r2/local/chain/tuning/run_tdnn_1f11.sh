...
# 1f11 is as 1f10 but adding "--constrained false" to the egs.
# Seems slightly better.

#local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f{10,11}_sp_bi
# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10_sp_bi exp/chain_cleaned/tdnn1f11_sp_bi
# System                tdnn1f10_sp_bi tdnn1f11_sp_bi
# WER on dev(orig)            8.4       8.1
# WER on dev(rescored)        7.6       7.4
# WER on test(orig)           8.4       8.2
# WER on test(rescored)       7.8       7.8
# Final train prob        -0.0844   -0.0724
# Final valid prob        -0.0965   -0.0864
# Final train prob (xent)   -1.0073   -1.0053
# Final valid prob (xent)   -1.0901   -1.0813
# Num-params                18081056  18081056
...
tdnn_affix=1f11  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
