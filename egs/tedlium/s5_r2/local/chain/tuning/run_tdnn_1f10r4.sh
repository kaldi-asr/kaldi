...
# 1f10r4 is as 1f10r2 but removing the bypass-scale.  This is to verify that
# that bypass stuff was actually helping.

# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10r{,2,4}_sp_bi
# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10r_sp_bi exp/chain_cleaned/tdnn1f10r2_sp_bi exp/chain_cleaned/tdnn1f10r4_sp_bi
# System                tdnn1f10r_sp_bi tdnn1f10r2_sp_bi tdnn1f10r4_sp_bi
# WER on dev(orig)            8.1       8.0       8.1
# WER on dev(rescored)        7.6       7.3       7.6
# WER on test(orig)           8.3       8.2       8.3
# WER on test(rescored)       7.8       7.7       7.7
# Final train prob        -0.0660   -0.0637   -0.0691
# Final valid prob        -0.0893   -0.0885   -0.0917
# Final train prob (xent)   -0.9079   -0.9122   -0.9328
# Final valid prob (xent)   -1.0068   -0.9988   -1.0151
...
tdnn_affix=1f10r4  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  tdnnf_opts="l2-regularize=0.004 dropout-proportion=0.0"
