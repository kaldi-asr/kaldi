...
# Not that good (although 1e is good, strangely, with fewer parameters).
# I have to investigate whether the scale of 0.5 is too small or too large.
# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10_sp_bi exp/chain_cleaned/tdnn1f10b_sp_bi exp/chain_cleaned/tdnn1f10c_sp_bi exp/chain_cleaned/tdnn1f10d_sp_bi
# System                tdnn1f10_sp_bi tdnn1f10b_sp_bi tdnn1f10c_sp_bi tdnn1f10d_sp_bi
# WER on dev(orig)            8.4       8.3       8.4       8.7
# WER on dev(rescored)        7.6       7.7       7.7       8.0
# WER on test(orig)           8.4       8.4       8.3       8.8
# WER on test(rescored)       7.8       7.9       7.7       8.3
# Final train prob        -0.0844   -0.0861   -0.0856   -0.0918
# Final valid prob        -0.0965   -0.0984   -0.0981   -0.1027
# Final train prob (xent)   -1.0073   -1.0232   -1.0295   -1.1099
# Final valid prob (xent)   -1.0901   -1.0991   -1.1094   -1.1838
# Num-params                18081056  17031200  17031200  17031200
...
tdnn_affix=1f10d  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  linear-component name=tdnn5l dim=256 input=Sum(Scale(0.5,tdnn3sum), tdnn4) $linear_opts
