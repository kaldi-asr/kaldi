...
# 1f10b is as 1f10 but changing all 1280's to 1024.
# It's a baseline for a future experiment.  There is no clear difference.

# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10_sp_bi exp/chain_cleaned/tdnn1f10b_sp_bi
# System                tdnn1f10_sp_bi tdnn1f10b_sp_bi
# WER on dev(orig)            8.4       8.3
# WER on dev(rescored)        7.6       7.7
# WER on test(orig)           8.4       8.4
# WER on test(rescored)       7.8       7.9
# Final train prob        -0.0844   -0.0861
# Final valid prob        -0.0965   -0.0984
# Final train prob (xent)   -1.0073   -1.0232
# Final valid prob (xent)   -1.0901   -1.0991
# Num-params                18081056  17031200
...
tdnn_affix=1f10b  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
