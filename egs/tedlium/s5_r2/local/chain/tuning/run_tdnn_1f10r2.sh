...
#  way, using 'tdnnf-layer'.  The only substantive difference was that I fixed an
#  issue whereby the tdnn2 layer (IIRC) was missing its within-bottleneck splicing
#  and linear transform.

# Better!
# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10r_sp_bi exp/chain_cleaned/tdnn1f10r2_sp_bi
# System                tdnn1f10r_sp_bi tdnn1f10r2_sp_bi
# WER on dev(orig)            8.1       8.0
# WER on dev(rescored)        7.6       7.3
# WER on test(orig)           8.3       8.2
# WER on test(rescored)       7.8       7.7
# Final train prob        -0.0660   -0.0637
# Final valid prob        -0.0893   -0.0885
# Final train prob (xent)   -0.9079   -0.9122
# Final valid prob (xent)   -1.0068   -0.9988
# Num-params                 8642592   8675360
...
tdnn_affix=1f10r2  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
