...
# 10d is not ready yet but it's the best setup so far.
# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10_sp_bi exp/chain_cleaned/tdnn1f10b_sp_bi exp/chain_cleaned/tdnn1f10c_sp_bi exp/chain_cleaned/tdnn1f10e_sp_bi
# System                tdnn1f10_sp_bi tdnn1f10b_sp_bi tdnn1f10c_sp_bi tdnn1f10e_sp_bi
# WER on dev(orig)            8.4       8.3       8.4       8.1
# WER on dev(rescored)        7.6       7.7       7.7       7.5
# WER on test(orig)           8.4       8.4       8.3       8.2
# WER on test(rescored)       7.8       7.9       7.7       7.7
# Final train prob        -0.0844   -0.0861   -0.0856   -0.0838
# Final valid prob        -0.0965   -0.0984   -0.0981   -0.0967
# Final train prob (xent)   -1.0073   -1.0232   -1.0295   -1.0139
# Final valid prob (xent)   -1.0901   -1.0991   -1.1094   -1.0888
# Num-params                18081056  17031200  17031200  13426720
...
tdnn_affix=1f10e  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  linear-component name=tdnn5l dim=192 input=Sum(Scale(0.5,tdnn3sum), tdnn4) $linear_opts
