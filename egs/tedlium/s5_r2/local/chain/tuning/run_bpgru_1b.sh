...
# run_bpgru_1b.sh is the same as run_bpgru_1a.sh, but using the fast-pgru-layer 
# ./local/chain/compare_wer_general.sh exp/chain_cleaned/blstm_1a_sp_bi exp/chain_cleaned/bpgru_1a_sp_bi/ exp/chain_cleaned/bpgru_1b_sp_bi/
# System                blstm_1a_sp_bi bpgru_1a_sp_bi bpgru_1b_sp_bi
# WER on dev(orig)            8.5       8.3       8.7
# WER on dev(rescored)        7.9       7.7       7.9
# WER on test(orig)           8.8       8.4       8.5
# WER on test(rescored)       8.4       8.1       8.1
# Final train prob        -0.0395   -0.0420   -0.0655
# Final valid prob        -0.0803   -0.0808   -0.1057
# Final train prob (xent)   -0.6197   -0.6394   -0.6599
# Final valid prob (xent)   -0.7945   -0.7979   -0.8472

## how you run this
# by default, with cleanup:
# local/chain/tuning/run_bpgru_1b.sh

# without cleanup:
# local/chain/tuning/run_bpgru_1b.sh --train-set train --gmm tri3 --nnet3-affix ""
...
pgru_affix=1b  #affix for PGRU directory, e.g. "a" or "b", in case we change the configuration.
...
dir=exp/chain${nnet3_affix}/bpgru_${pgru_affix}_sp_bi
