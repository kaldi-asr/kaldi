...
# was helpful there).
# This time it wasn't helpful-- possibly slightly worse.  Maybe it was just noise.

# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10q_sp_bi exp/chain_cleaned/tdnn1f10r_sp_bi
# System                tdnn1f10q_sp_bi tdnn1f10r_sp_bi
# WER on dev(orig)            8.0       8.1
# WER on dev(rescored)        7.6       7.6
# WER on test(orig)           8.3       8.3
# WER on test(rescored)       7.8       7.8
# Final train prob        -0.0653   -0.0660
# Final valid prob        -0.0899   -0.0893
# Final train prob (xent)   -0.9072   -0.9079
# Final valid prob (xent)   -0.9976   -1.0068
...
tdnn_affix=1f10r  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
