...
# 1f10o is as 1f10j but changing Scale(0.66,...) to Scale(0.75,..).
# A little worse.

# local/chain/compare_wer_general.sh exp/chain_cleaned/tdnn1f10i_sp_bi exp/chain_cleaned/tdnn1f10j_sp_bi exp/chain_cleaned/tdnn1f10o_sp_bi
# System                tdnn1f10i_sp_bi tdnn1f10j_sp_bi tdnn1f10o_sp_bi
# WER on dev(orig)            8.0       8.1       8.2
# WER on dev(rescored)        7.6       7.5       7.4
# WER on test(orig)           8.3       8.1       8.1
# WER on test(rescored)       7.9       7.5       7.8
# Final train prob        -0.0615   -0.0623   -0.0621
# Final valid prob        -0.0887   -0.0900   -0.0916
# Final train prob (xent)   -0.9129   -0.9213   -0.9286
# Final valid prob (xent)   -1.0283   -1.0355   -1.0483
# Num-params                 8265760   8265760   8265760
...
tdnn_affix=1f10o  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  no-op-component name=tdnn2sum input=Sum(Scale(0.75,tdnn1),tdnn2)
  ...
  no-op-component name=tdnn3sum input=Sum(Scale(0.75,tdnn2sum), tdnn3)
  ...
  no-op-component name=tdnn4sum input=Sum(Scale(0.75,tdnn3sum), tdnn4)
  ...
  no-op-component name=tdnn5sum input=Sum(Scale(0.75,tdnn4sum), tdnn5)
  ...
  no-op-component name=tdnn6sum input=Sum(Scale(0.75,tdnn5sum), tdnn6)
  ...
  no-op-component name=tdnn7sum input=Sum(Scale(0.75,tdnn6sum), tdnn7)
  ...
  no-op-component name=tdnn8sum input=Sum(Scale(0.75,tdnn7sum), tdnn8)
  ...
  no-op-component name=tdnn9sum input=Sum(Scale(0.75,tdnn8sum), tdnn9)
  ...
  no-op-component name=tdnn10sum input=Sum(Scale(0.75,tdnn9sum), tdnn10)
  ...
  no-op-component name=tdnn11sum input=Sum(Scale(0.75,tdnn10sum), tdnn11)
