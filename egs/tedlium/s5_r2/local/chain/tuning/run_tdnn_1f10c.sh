...
# WER on dev(rescored)        7.6       7.7       7.7
# WER on test(orig)           8.4       8.4       8.3
# WER on test(rescored)       7.8       7.9       7.7
# Final train prob        -0.0844   -0.0861   -0.0856
# Final valid prob        -0.0965   -0.0984   -0.0981
# Final train prob (xent)   -1.0073   -1.0232   -1.0295
# Final valid prob (xent)   -1.0901   -1.0991   -1.1094
# Num-params                18081056  17031200  17031200
...
tdnn_affix=1f10c  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  no-op-component name=tdnn2sum input=Sum(tdnn1,tdnn2)
  ...
  no-op-component name=tdnn3sum input=Sum(tdnn2, tdnn3)
  ...
  linear-component name=tdnn5l dim=256 input=Sum(tdnn3, tdnn4) $linear_opts
  relu-batchnorm-dropout-layer name=tdnn5 $opts dim=1024 input=Append(0, tdnn3l)
  no-op-component name=tdnn5sum input=Sum(tdnn4, tdnn5)
  ...
  no-op-component name=tdnn6sum input=Sum(tdnn5, tdnn6)
  ...
  no-op-component name=tdnn7sum input=Sum(tdnn6, tdnn7)
  ...
  no-op-component name=tdnn8sum input=Sum(tdnn7, tdnn8)
  ...
  no-op-component name=tdnn9sum input=Sum(tdnn8, tdnn9)
  ...
  no-op-component name=tdnn10sum input=Sum(tdnn9, tdnn10)
  ...
  no-op-component name=tdnn11sum input=Sum(tdnn10, tdnn11)
