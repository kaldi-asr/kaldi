...
tdnn_affix=1f10r5  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  tdnnf-layer name=tdnnf5 $tdnnf_opts dim=1024 bottleneck-dim=96 time-stride=1
  tdnnf-layer name=tdnnf6 $tdnnf_opts dim=1024 bottleneck-dim=96 time-stride=0
  ...
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=1024 bottleneck-dim=96 time-stride=3
