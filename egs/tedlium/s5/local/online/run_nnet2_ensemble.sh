...
train_stage=-10
use_gpu=true
dir=exp/nnet2_online/nnet_ms_ensemble
...
if [ $stage -le 7 ]; then
  ...
  # in real-time.
  steps/nnet2/train_multisplice_ensemble.sh --stage $train_stage \
    ...
    --io-opts "--max-jobs-run 18" \
    --initial-effective-lrate 0.0015 --final-effective-lrate 0.00015 \
    --cmd "$decode_cmd" \
    --pnorm-input-dim 4500 \
    --pnorm-output-dim 450 \
    --mix-up 12000 \
