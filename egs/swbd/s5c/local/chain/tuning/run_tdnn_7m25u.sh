...
# splicing.  Better on eval2000 and rt03 by 0.1 to 0.2, but worse on
#  train_dev by 0.2 to 0.3.  So not super clear.  But promising.

# local/chain/compare_wer_general.sh --rt03 tdnn7m25q_sp tdnn7m25t_sp tdnn7m25u_sp
# System                tdnn7m25q_sp tdnn7m25t_sp tdnn7m25u_sp
# WER on train_dev(tg)      12.05     11.64     11.92
# WER on train_dev(fg)      11.08     10.74     10.95
# WER on eval2000(tg)        14.8      14.7      14.6
# WER on eval2000(fg)        13.2      13.2      13.1
# WER on rt03(tg)            18.0      17.9      17.7
# WER on rt03(fg)            15.7      15.8      15.6
# Final train prob         -0.076    -0.074    -0.075
# Final valid prob         -0.091    -0.089    -0.089
# Final train prob (xent)        -0.982    -0.904    -0.883
# Final valid prob (xent)       -1.0077   -0.9288   -0.9076
# Num-parameters               22735140  23259428  24439076
