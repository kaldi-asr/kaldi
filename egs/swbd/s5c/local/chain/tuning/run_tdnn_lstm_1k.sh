...
# run_tdnn_lstm_1k.sh is like run_tdnn_lstm_1e.sh
# but with reduced right context
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_lstm_1k # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_nj=50
...
if [ $stage -le 12 ]; then
  ...
  relu-renorm-layer name=tdnn7 input=Append(-3,0) dim=1024
