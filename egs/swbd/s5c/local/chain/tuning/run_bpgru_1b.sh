...
# run_bpgru_1b is the same as 1a, but using the fast version pgru

# ./local/chain/compare_wer_general.sh run_bpgru_1a bpgru_1b_sp
# System                run_bpgru_1a bpgru_1b_sp
# WER on train_dev(tg)      13.32     13.26
# WER on train_dev(fg)      12.20     12.44
# WER on eval2000(tg)        15.2      15.4
# WER on eval2000(fg)        13.9      13.9
# Final train prob         -0.062    -0.063
# Final valid prob         -0.081    -0.084
# Final train prob (xent)        -0.806    -0.814
# Final valid prob (xent)       -0.9127   -0.9291
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/bprgu_1b  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
