...
# Based on tdnn_lstm_1b, but adding proposed CNN and batch-norm also dropout to the sscripts

# ./local/chain/compare_wer_general.sh tdnn_lstm_1b_ld5_sp cnn_tdnn_lstm_1b_ld5_sp
# System                tdnn_lstm_1b_ld5_sp cnn_tdnn_lstm_1b_ld5_sp
# WER on train_dev(tg)      12.88     12.05
# WER on train_dev(fg)      11.96     11.15
# WER on eval2000(tg)        15.5      14.3
# WER on eval2000(fg)        14.0      13.0
# Final train prob         -0.049    -0.069
# Final valid prob         -0.093    -0.092
# Final train prob (xent)        -0.758    -0.891
# Final valid prob (xent)       -0.9662   -1.0016
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/cnn_tdnn_lstm_1b # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
remove_egs=false
common_egs_dir=exp/chain/tdnn_lstm_1b_ld5_sp/egs
