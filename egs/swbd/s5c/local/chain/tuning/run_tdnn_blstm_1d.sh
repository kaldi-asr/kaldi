...
if [ $stage -le 12 ]; then
  ...
  relu-renorm-layer name=tdnn4 input=Append(Offset(Append(blstm1-forward, blstm1-backward), -3),Append(blstm1-forward,blstm1-backward),Offset(Append(blstm1-forward,blstm1-backward),3)) dim=512
  relu-renorm-layer name=tdnn5 input=Append(-3,0,3) dim=512


  fast-lstmp-layer name=blstm2-forward input=tdnn5 cell-dim=1024 recurrent-projection-dim=256 non-recurrent-projection-dim=256 delay=-3 $lstm_opts
  fast-lstmp-layer name=blstm2-backward input=tdnn5 cell-dim=1024 recurrent-projection-dim=256 non-recurrent-projection-dim=256 delay=3 $lstm_opts
  relu-renorm-layer name=tdnn6 input=Append(Offset(Append(blstm2-forward, blstm2-backward), -3),Append(blstm2-forward,blstm2-backward),Offset(Append(blstm2-forward,blstm2-backward), 3)) dim=512
  relu-renorm-layer name=tdnn7 input=Append(-3,0,3) dim=512


  fast-lstmp-layer name=blstm3-forward input=tdnn7 cell-dim=1024 recurrent-projection-dim=256 non-recurrent-projection-dim=256 delay=-3 $lstm_opts
  fast-lstmp-layer name=blstm3-backward input=tdnn7 cell-dim=1024 recurrent-projection-dim=256 non-recurrent-projection-dim=256 delay=3 $lstm_opts
