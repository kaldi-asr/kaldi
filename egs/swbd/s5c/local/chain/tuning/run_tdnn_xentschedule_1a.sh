...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_xentschedule_1a  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
if [ $stage -le 12 ]; then
  ...
  learning_rate_factor=$(echo "print 0.5/0.15" | python)
