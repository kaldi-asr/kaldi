...
if [ $stage -le 12 ]; then
 ...
 steps/nnet3/chain/train_tdnn.sh --stage $train_stage \
    ...
    --jesus-opts "--num-jesus-blocks 84 --jesus-forward-input-dim 500  --jesus-forward-output-dim 1700 --jesus-hidden-dim 2500 --jesus-stddev-scale 0.2 --final-layer-learning-rate-factor 0.25  --self-repair-scale-nonlinearity 0.00001" \
