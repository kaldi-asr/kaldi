...
# f is as b, but with leaky xent

#System                  tdnn_7htdnn_leak6btdnn_leak6f
#WER on train_dev(tg)      13.96     14.26     14.14
#WER on train_dev(fg)      12.86     13.09     13.01
#WER on eval2000(tg)        16.5      16.8      16.8
#WER on eval2000(fg)        14.8      15.3      15.1
#Final train prob     -0.0925208-0.0912405-0.0907096
#Final valid prob      -0.116597 -0.114332 -0.113796
#Final train prob (xent)        -1.317  -1.30061  -1.29778
#Final valid prob (xent)      -1.40473  -1.39084  -1.36411


# --> it has almost no effect. but the objf has been improved a little.
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_leak6f  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
