...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/tdnn_boosted_a  # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
...
frames_per_eg=150
remove_egs=false
common_egs_dir=/export/a11/hhadian/master/egs/swbd/s5c/exp/chain/tdnn_7h_sp/egs
xent_regularize=0.1
boost=0.1
hard_boost=false
