...
# run_tdnn_1f.sh is like run_tdnn_1c.sh, it looks like 1a with xconfig.

#exp/chain_cleaned/tdnn_1f_sp: num-iters=871 nj=3..16 num-params=17.1M dim=40+100->5151 combine=-0.074->-0.074 xent:train/valid[579,870,final]=(-1.02,-0.986,-0.990/-0.985,-0.953,-0.957) logprob:train/valid[579,870,final]=(-0.066,-0.062,-0.063/-0.070,-0.069,-0.069)

# by default, with cleanup:
# local/chain/run_tdnn.sh

# local/chain/compare_wer.sh exp/chain_cleaned/tdnn_1f_sp
