...
from ltlm.modules.lattice_positional_embedding import LatticePositionalEmbedding
...
class LatticeTransformerSentenceEncoder(nn.Module):
    """
    It is TransformerSentenceEncoder with special positional embeddings and gradient checkpoiting

    TransformerSentenceEncoder doc:
    ...
    def forward(
        ...
        if self.arc_emb2emb is not None:
            x = self.arc_emb2emb(x)
