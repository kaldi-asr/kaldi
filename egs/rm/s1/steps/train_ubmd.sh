...
# Train UBM from a trained HMM/GMM system [with splice+LDA+ET features]
...
for x in 0 1 2 3; do
    echo "Pass $x"
    feats="ark:scripts/subset_scp.pl ${subset[$x]} data/train.scp | splice-feats scp:- ark:- | transform-feats $mat ark:- ark:- | transform-feats $utt2spk_opt ark,s,cs:$trans ark:- ark:- |"
