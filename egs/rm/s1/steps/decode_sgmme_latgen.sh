...
for test in mar87 oct87 feb89 oct89 feb91 sep92; do
 (
  ...
  sgmm-latgen-simple "$gselect_opt" $utt2spk_opt --spk-vecs=ark:$dir/test_${test}.vecs2 --beam=20.0 --acoustic-scale=0.1 --word-symbol-table=data/words.txt $model $graphdir/HCLG.fst "$feats" "ark,t:|gzip -c > $dir/test_${test}.lat.gz" 2> $dir/decode_${test}.log

  # Now rescore lattices with various acoustic scales, and compute the WER.
 for inv_acwt in 5 6 7 8 9 10; do
...
for inv_acwt in 5 6 7 8 9 10; do
 grep WER $dir/wer_{mar87,oct87,feb89,oct89,feb91,sep92}_${inv_acwt} | \
