...
dir=exp/decode_nnet_tri2a_s5
mkdir -p $dir

dir_nnet=exp/nnet_tri2a_s5
...
for test in mar87 oct87 feb89 oct89 feb91 sep92; do
 (
  #get features
  delta=0
  feats="ark:add-deltas --delta-order=$delta --print-args=false scp:data/test_${test}_fbank.scp ark:- |"
