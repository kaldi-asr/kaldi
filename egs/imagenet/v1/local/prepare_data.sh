...
# This script loads the training and test data for Imagenet 2012 Task 1 or 3 Classification
...
# Requires the datasets for Task 1: "development kit", "training images", "validation images", and "test images"
...
# Extra
# For when running the task 3 the devkit used for classes.txt still needs to be from task 1
