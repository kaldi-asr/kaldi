...
if [ $stage -le 4 ]; then
  ...
  # TEMP
  # tail -n 10 data/local/dict/lexiconp.txt | awk '{ print "XXX"$0 }' > $tree_dir/extvocab_lexicon/lexiconp.txt
...
EOF
  ...
  utils/lang/extend_lang.sh  data/lang_nosp_basevocab $tree_dir/extvocab_lexicon/lexiconp.txt  data/lang_nosp_extvocab
fi
