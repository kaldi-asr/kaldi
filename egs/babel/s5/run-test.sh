...
#-for q in exp/tri5/decode_shadow.uem* ; do
...
steps/decode_fmllr.sh --skip-scoring true --nj 64 --cmd "$decode_cmd" \
  exp/tri5/graph data/shadow.uem exp/tri5/decode_shadow.uem &> exp/tri5/decode_shadow.uem.log
...
####################################################################
steps/decode_fmllr.sh --skip-scoring true --nj 64 --cmd "$decode_cmd" \
  exp/tri5/graph data/test.uem exp/tri5/decode_test.uem &> exp/tri5/decode_test.uem.log
