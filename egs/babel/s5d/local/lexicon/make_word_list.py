...
def main():
    ...
    parser.add_argument(
        "transcripts_list", help="Path to list of training " "transcripts"
    )
    parser.add_argument(
        "transcripts_dir", help="Path to the training " "transcripts directory"
    )
    parser.add_argument(
        "word_list", help="Path to the generated word list" " of training words"
    )
    parser.add_argument(
        "--misprons",
        help="Path to the generated word list" " of mispronounced words",
        action="store",
        default=None,
    )
