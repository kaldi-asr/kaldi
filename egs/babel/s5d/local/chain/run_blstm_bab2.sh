...
# %WER 46.7 | 19252 60586 | 57.1 26.1 16.8 3.8 46.7 31.9 | -0.692 | exp/chain_cleaned/blstmbab2_sp_bi/decode_dev10h.pem/score_10/penalty_0.0/dev10h.pem.ctm.sys
...
blstm_affix=bab2  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
