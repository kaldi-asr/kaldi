...
# %WER 45.9 | 19252 60586 | 58.7 28.0 13.3 4.6 45.9 31.6 | -0.668 | exp/chain_cleaned/blstmbab3_sp_bi/decode_dev10h.pem/score_9/penalty_0.0/dev10h.pem.ctm.sys
...
blstm_affix=bab3  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
