...
latticeLocation = {
    1: "/export/a04/gkumar/kaldi-trunk/egs/fishcall_es/j-1/latjosh-2/lattices-pushed/",
...
def findLattice(timeDetail):
    ...
    if searchKey in latticeDict:
        return (
            "/export/a04/gkumar/kaldi-trunk/egs/fishcall_es/j-"
            + latticeDict[searchKey]
            + "/latjosh-2/lattices-pushed/"
            + searchKey
        )
    else:
        return -1
    ...
    for line in timingFile:
        ...
        if mergedTranslation != "":
            ...
            proc = subprocess.Popen(
                "/export/a04/gkumar/corpora/fishcall/bin/fsm2plf.sh /export/a04/gkumar/kaldi-trunk/egs/fishcall_es/j-matt/data/lang/words.clean.txt "
                + finalFST,
