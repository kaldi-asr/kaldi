...
# head exp/chainfsf4/cnn1a_1/decode_test/scoring_kaldi/best_wer
#%WER 18.34 [ 3231 / 17616, 348 ins, 693 del, 2190 sub ] exp/chainfsf4/cnn1a_1/decode_test/wer_8_1.0
...
gmm_dir=exp5/${gmm}
ali_dir=exp5/${ali}
lat_dir=exp5/chain${nnet3_affix}/${gmm}_${train_set}_lats
...
tree_dir=exp5/chain${nnet3_affix}/tree
...
if [ $stage -le 4 ]; then
  ...
  input dim=52 name=input

  conv-relu-batchnorm-layer name=cnn1 height-in=52 height-out=52 time-offsets=-3,-2,-1,0,1,2,3 $common1
  conv-relu-batchnorm-layer name=cnn2 height-in=52 height-out=26 time-offsets=-2,-1,0,1,2 $common1 height-subsample-out=2
  conv-relu-batchnorm-layer name=cnn3 height-in=26 height-out=26 time-offsets=-4,-2,0,2,4 $common2
  conv-relu-batchnorm-layer name=cnn4 height-in=26 height-out=13 time-offsets=-4,-2,0,2,4 $common2 height-subsample-out=2
