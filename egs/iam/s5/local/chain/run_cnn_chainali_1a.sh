...
nj=30
train_set=train
gmm=tri2_8states_4sil_10000_500_20000_500_20000        # this is the source gmm-dnir that we'll use for alignments; it
...
chain_model_dir=exp/chain_cleaned/cnn1b
tree_dir=exp/chain${nnet3_affix}/tree_NL500
...
if [ $stage -le 4 ]; then
  ...
  common3="required-time-offsets=0 height-offsets=-2,-1,0,1,2 num-filters-out=90"
  common4="required-time-offsets=0 height-offsets=-1,0,1 num-filters-out=90"
  mkdir -p $dir/configs
