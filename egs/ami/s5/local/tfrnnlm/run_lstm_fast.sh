...
dir=data/tensorflow_fast_lstm_parallel
mkdir -p $dir
...
#  $cuda_cmd $dir/train_rnnlm.log utils/parallel/limit_num_gpus.sh \
    python -u steps/tfrnnlm/lstm_fast.py --data-path=$dir --hidden-dim=20 --save-path=$dir/rnnlm --vocab-path=$dir/wordlist.rnn.final
fi
