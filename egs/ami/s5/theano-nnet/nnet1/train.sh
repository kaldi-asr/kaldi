...
train_tool=theano-nnet/nnet1/train.py # optionally change the training tool
...
python $train_tool \
  --nnet-proto=$nnet_proto $feats_opts \
  ${config:+ --config=$config} \
  $dir/train.scp $dir/cv.scp $labels_tr $labels_cv $dir || exit 1;
