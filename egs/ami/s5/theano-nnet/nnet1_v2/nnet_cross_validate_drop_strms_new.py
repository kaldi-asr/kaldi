...
if len(o.strm_indices) == 0 or o.comb_num == '0':
  logging.error("Use nnet_cross_validate.py for normal CV")
  sys.exit(1)
...
(strm_indices, comb_num) = (o.strm_indices, o.comb_num)
with kaldi_io.KaldiScpReader(cv_scp, feature_preprocess.full_preprocess, reader_args=[feat_preprocess, cv_cmvn.utt2spk_dict, cv_cmvn.cmvn_dict]) as cv_data_it:
  for ii, (X, t) in enumerate(apply_strm_mask(features.fea_lab_pair_iter(cv_data_it, cv_lab_dict), strm_indices, comb_num)):
