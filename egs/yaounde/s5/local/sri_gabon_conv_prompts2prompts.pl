#!/usr/bin/perl -w
#sri_gabon_conv_prompts2prompts.pl - make promt files for each speaker
use strict;
use warnings;
use Carp;

BEGIN {
    @ARGV == 2 or croak "USAGE: sri_gabon_conv_prompts2prompts.pl WAVFILELIST PROMPTSLIST
output:
...
It looks like this script is independent of read or conv
";
}
