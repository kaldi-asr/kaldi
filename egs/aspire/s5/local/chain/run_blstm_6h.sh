...
echo "There are no results available for this script. BLSTM decoding does
not produce good results, even though the frame accuracies are really
good. If you want to run this experiment delete this line." && exit 1;
