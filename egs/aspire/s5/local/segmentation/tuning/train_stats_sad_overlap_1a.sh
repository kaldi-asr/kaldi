...
snr_scp=data/train_aztec_unsad_whole_corrupted_sp_hires_bp_2400/irm_targets.scp
deriv_weights_for_irm_scp=data/train_aztec_unsad_whole_corrupted_sp_hires_bp_2400/deriv_weights_manual_seg.scp 
