...
if [ $stage -le 3 ]; then
  ...
  relu-renorm-layer name=tdnn1 input=Append(-3,-2,-1,0,1,2,3) dim=256
  stats-layer name=tdnn2.stats config=mean+count(-99:3:9:99)
  relu-renorm-layer name=tdnn2 input=Append(Offset(tdnn1, -6), tdnn1, tdnn2.stats) dim=256
