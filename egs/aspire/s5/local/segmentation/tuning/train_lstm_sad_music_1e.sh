...
utils/combine_data.sh --extra-files "deriv_weights.scp speech_labels.scp music_labels.scp" \
...
if [ $stage -le 0 ]; then
  utils/combine_data.sh --extra-files "speech_labels.scp deriv_weights.scp" \
