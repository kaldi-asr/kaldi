...
# This script is same as 1d, but add add-log-stddev to norm layers.
...
min_extra_left_context=79
min_extra_right_context=11
...
if [ $stage -le 1 ]; then
  ...
  stats-layer name=tdnn3_stats config=mean+count(-108:9:27:108)
  relu-renorm-layer name=tdnn3 input=Append(tdnn2@-27, tdnn2@-9, tdnn2, tdnn2@9, tdnn3_stats) dim=256 add-log-stddev=true
