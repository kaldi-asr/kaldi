...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--snrs", type=str, default="20:10:0", help="snrs to be used for corruption"
    )
    parser.add_argument(
        "--check-output-exists",
        type=str,
    ...
    parser.add_argument(
        "output_wav_file_list", type=str, help="wav.scp file to write corrupted output"
    )
    parser.add_argument(
        "impulses_noises_dir",
        type=str,
    ...
    parser.add_argument(
        "output_command_file", type=str, help="file to output the corruption commands"
    )
