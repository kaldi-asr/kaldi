...
if [ $stage -le 7 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(-2,-1,0,1,2) dim=256
  relu-batchnorm-layer name=tdnn2 input=Append(-2,0,2) dim=256
  relu-batchnorm-layer name=tdnn3 input=Append(-3,0,3) dim=256
  relu-batchnorm-layer name=tdnn4 dim=256
