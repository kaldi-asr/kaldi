...
# exp/cnn1a/: num-iters=80 nj=1..2 num-params=0.5M dim=96->10 combine=-0.11->-0.10 loglike:train/valid[52,79,final]=(-0.07,-0.03,-0.03/-0.21,-0.22,-0.21) accuracy:train/valid[52,79,final]=(0.98,0.99,0.99/0.95,0.95,0.95)
