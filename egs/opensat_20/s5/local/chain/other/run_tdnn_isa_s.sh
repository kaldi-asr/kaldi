...
if [ $stage -le 11 ]; then
  ...
  steps/align_si.sh --nj 30 --cmd "$train_cmd" \
       data/$mic/train_safet data/lang exp/$mic/tri3 exp/$mic/tri3_train_ali_aug
  nj=$(cat exp/$mic/tri3_train_ali_aug/num_jobs) || exit 1;
  steps/align_fmllr_lats.sh --nj $nj --cmd "$train_cmd" data/$mic/train_safet \
    data/lang exp/$mic/tri3 exp/$mic/tri3_train_lats_aug
...
if [ $stage -le 13 ]; then
  ...
  steps/nnet3/chain/build_tree.sh --frame-subsampling-factor 3 \
      ...
      --cmd "$train_cmd" 5500 ${lores_train_data_dir} data/lang_chain $ali_dir $tree_dir
fi
