...
tdnn_affix=1a_13_1024_128_tedlium_baseline  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
#common_egs_dir=/exp/aarora/kaldisat/egs/opensat2020/s5/exp/chain/tdnn1a_13_lr001_1024_128_st9_sp/egs  # you can set this to use previously dumped egs.
common_egs_dir=
remove_egs=true
srand=0
