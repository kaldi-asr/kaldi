...
. path.sh
data_dir=/home/ndjaitly/Data/TIMIT
#data_dir=/ais/gobi2/speech/TIMIT
local/timit_data_prep.sh $data_dir || exit 1;
...
scripts/mkgraph.sh --mono data/lang exp/mono exp/mono/graph || exit 1;
