...
train_stage=-10
get_egs_stage=-10
dir=exp/chain/cnn_resnet_tdnn_lstm_1a  # Note: _sp will get added to this
decode_iter=
...
if [ $stage -le 10 ]; then
  ...
  conv-relu-batchnorm-layer name=cnn2 input=res3 height-in=20 height-out=20 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  ...
  conv-relu-batchnorm-layer name=cnn3 input=res6 height-in=20 height-out=20 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
