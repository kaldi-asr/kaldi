...
# Sliding-window CMVN and VAD (voice activity detection) have been applied
# to MFCC when getting tandem features. We don't apply them when preparing
# features to train ivector extractor in this script.
