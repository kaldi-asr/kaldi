...
#             2013  Daniel Povey
#             2014  David Snyder
#             2017  Speech and Multimodal Intelligent Information Processing Lab, SYSU (Author: Danwei Cai)
#             2017  Speech and Multimodal Intelligent Information Processing Lab, SYSU (Author: Ming Li)
# Apache 2.0.

# This is a modified version of sid/train_diag_ubm.sh, specialized for
# tandem (MFCC + PPP/PCA) features trained UBM. Sliding-window CMVN and VAD
# (voice activity detection) have been applied to MFCC when getting tandem
# features. We don't apply them when preparing features to train UBM in this
# script.
...
all_feats="scp:$data/feats.scp"
feats="ark,s,cs:subsample-feats --n=$subsample scp:$sdata/JOB/feats.scp ark:- |"
