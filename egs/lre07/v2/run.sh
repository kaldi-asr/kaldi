#!/bin/bash
# Copyright  2016   GoVivace Inc. (Author: Mousmita Sarma) 
#                   
# Apache 2.0.
#
...
local/make_sre_2008_train.pl /home/mousmita/DATA/LDC2011S05 data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S60 vietnamese data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S59 tamil data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S53 japanese data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S52 hindi data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S51 german data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S50 farsi data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S48 french data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S49 arabic.standard data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S54 korean data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S55 chinese.mandarin.mainland data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S56 chinese.mandarin.taiwan data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S57 spanish.caribbean data
local/make_callfriend.pl /home/mousmita/DATA/LDC96S58 spanish.noncaribbean data
local/make_lre96.pl /home/mousmita/DATA/lid96e1 data
local/make_lre03.pl /home/mousmita/DATA/LDC2006S31 data
local/make_lre05.pl /home/mousmita/DATA/LDC2008S05 data
local/make_lre07_train.pl /home/mousmita/DATA/LDC2009S05/package/lid07tr1 data
local/make_lre09.pl /home/mousmita/DATA/LRE2009/eval data
...
local/make_lre07.pl /home/mousmita/DATA/LDC2009S04 data/lre07_all
...
# We have skipped the VTLN warping step below unlike the v1 recipe of lre07
use_vtln=false
if $use_vtln; then
...
#Uncomment the following part if use_vtln=true above
...
# Train a logistic regression model on top of i-Vectors and evaluate it on the test data
