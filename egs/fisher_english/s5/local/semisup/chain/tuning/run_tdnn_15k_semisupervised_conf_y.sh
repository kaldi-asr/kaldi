...
# This script is same as _s, but uses naive splitting
...
comb_affix=comb1y  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
