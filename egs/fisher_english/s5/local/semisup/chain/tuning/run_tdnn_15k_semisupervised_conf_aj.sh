...
# This script is same as _ae, but uses 7i model and tree with UNK decoding
...
comb_affix=comb1aj  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
