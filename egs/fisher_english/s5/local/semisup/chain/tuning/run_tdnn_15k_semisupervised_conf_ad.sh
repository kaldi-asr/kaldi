...
# This script is same as _ac, but uses naive splitting.
...
comb_affix=comb1ad  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
