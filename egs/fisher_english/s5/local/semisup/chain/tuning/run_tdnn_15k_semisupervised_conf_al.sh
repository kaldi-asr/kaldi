...
# This script is same as _aj, but uses pocolm for LM.
...
comb_affix=comb1al  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
