...
# This script is same as _aa, but uses frames-per-eg of 150
...
comb_affix=comb1ae  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
