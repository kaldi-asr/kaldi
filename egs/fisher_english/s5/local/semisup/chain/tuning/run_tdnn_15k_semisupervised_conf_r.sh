...
comb_affix=comb1r  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
...
if [ $stage -le 15 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --trainer.objective-scales="output-1-xent:0.5" \
