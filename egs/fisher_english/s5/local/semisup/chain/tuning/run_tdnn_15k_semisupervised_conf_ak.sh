...
# This script is same as _aj, but uses 7i model and supervised lattices from UNK phone LM alignment.
...
comb_affix=comb1ak  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
