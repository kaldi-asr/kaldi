...
# This script is same as _m, but uses 3gram LM for decoding
...
comb_affix=comb1x  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
