...
# This script is same as _ae, but uses naive splitting.
...
comb_affix=comb1ah  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
