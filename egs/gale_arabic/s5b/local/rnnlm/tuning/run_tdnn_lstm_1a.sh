...
#rnnlm/train_rnnlm.sh: best iteration (out of 12) was 11, linking it to final iteration.
#rnnlm/train_rnnlm.sh: train/dev perplexity was 24.3 / 25.7.
#Train objf: -4.83 -4.19 -3.77 -3.57 -3.44 -3.36 -3.29 -3.24 -3.20 -3.16 -3.13
#Dev objf:   -5.21 -4.49 -3.95 -3.68 -3.54 -3.45 -3.38 -3.34 -3.30 -3.27 -3.25
...
ac_model_dir=exp/chain/tdnn_1b
