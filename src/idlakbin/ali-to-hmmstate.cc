...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        "Converts alignments (containing transition-ids) to hmm states.\n"
    ...
    std::string model_filename = po.GetArg(1),
        ...
        hmmstate_wspecifier = po.GetArg(3);
    ...
    Int32VectorWriter writer(hmmstate_wspecifier);
    int32 num_done = 0;
    ...
    KALDI_LOG << "Converted " << num_done << " alignments to hmmstate sequences.";
