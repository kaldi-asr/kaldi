...
///   In nnet-special-component.h we put components that still have the
///   kSimpleComponent flag but which are more special purpose: for
///   instance, components relating to LSTMs or CNNs or GRUs.
