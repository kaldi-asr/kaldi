...
// Copyright 2015  Xingyu Na, Jiayu Du (Jerry)
...
#ifndef KALDI_NNET_LSTM_STREAMS_H_
#define KALDI_NNET_LSTM_STREAMS_H_
...
public:
    LstmStreams(int32 input_dim, int32 output_dim) :
    ...
    Component* Copy() const { return new LstmStreams(*this); }
    ComponentType GetType() const { return kLstmStreams; }
...
private:
    // dims
    int32 ncell_;   // LSTM cell dim, same for recurrent and output
    int32 nstream_;
    ...
    // recurrent connections: from m to [g, i, f, o]
