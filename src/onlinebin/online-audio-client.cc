            ...
            while (true) {
                ...
                do {
                    ...
                    if (key == "NUM") {
                        ...
                        if (val != "WSEC") {
                            KALDI_ERR<<"Only WSEC format supported by this program!";
                        }
                    }
                ...
                for (int32 i = 0; i < res_num; i++) {
                    ...
                    std::string word_str, start_str, end_str,conf_str;
                    ...
                    word.conf = strtof(conf_str.c_str(),0);
