...
#ifndef KALDI_RNNLM_RNNLM_DIAGNOSTICS_H_
#define KALDI_RNNLM_RNNLM_DIAGNOSTICS_H_
...
struct LmNnetComputeProbOptions {
 ...
 */
class LmNnetComputeProb {
 public:
  // does not store a reference to 'config' but does store one to 'nnet'.
  LmNnetComputeProb(const LmNnetComputeProbOptions &config,
                    const LmNnet &nnet);
 ...
 private:
  ...
  LmNnetComputeProbOptions config_;
  const LmNnet &nnet_;
