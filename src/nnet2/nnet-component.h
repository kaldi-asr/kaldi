...
class PnormComponent: public Component {
 public:
  void Init(int32 dim, int32 group_size, BaseFloat p);
  explicit PnormComponent(int32 dim, int32 group_size = 5, BaseFloat p = 2) {
    Init(dim, group_size, p);
  }
  PnormComponent(): input_dim_(0), group_size_(0), p_(0) { }
