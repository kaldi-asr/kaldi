...
inline void cuda_matrix_add_indexed_values(dim3 Gr, dim3 Bl, float *data, MatrixDim dim, float alpha, const Int32Pair* indices, float* x, int s) { cudaF_matrix_add_indexed_values(Gr, Bl, data, dim, alpha, indices, x, s); }
...
inline void cuda_matrix_add_indexed_values(dim3 Gr, dim3 Bl, double *data, MatrixDim dim, double alpha, const Int32Pair* indices, double* x, int s) { cudaD_matrix_add_indexed_values(Gr, Bl, data, dim, alpha, indices, x, s); }
