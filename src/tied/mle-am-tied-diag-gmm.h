...
class AccumAmTiedDiagGmm {
 public:
  ...
  /// Accumulate stats for single GMM in the model and the respective
  /// codebook; returns log likelihood
  /// This will evaluate the associated codebook
  BaseFloat AccumulateForTied(const AmTiedDiagGmm &model,
  ...
  AccumDiagGmm& GetDiagAcc(int32 codebook_index) const;
