...
inline void
AmTiedDiagGmm::GetGaussianMean(int32 pdf_index, int32 gauss,
                                      VectorBase<BaseFloat> *out) const {
  KALDI_ASSERT((static_cast<size_t>(pdf_index) < densities_.size())
      && (densities_[pdf_index] != NULL));
...
inline void
AmTiedDiagGmm::GetGaussianVariance(int32 pdf_index, int32 gauss,
                                          VectorBase<BaseFloat> *out) const {
  KALDI_ASSERT((static_cast<size_t>(pdf_index) < densities_.size())
               && (densities_[pdf_index] != NULL));
...
inline void
AmTiedDiagGmm::SetGaussianMean(int32 pdf_index, int32 gauss_index,
                                      const VectorBase<BaseFloat> &in) {
  KALDI_ASSERT((static_cast<size_t>(pdf_index) < densities_.size())
               && (densities_[pdf_index] != NULL));
