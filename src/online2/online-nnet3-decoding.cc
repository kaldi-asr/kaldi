...
template class SingleUtteranceNnet3DecoderTpl<fst::GrammarFstTpl<const fst::ConstFst<fst::StdArc> > >;
template class SingleUtteranceNnet3DecoderTpl<fst::GrammarFstTpl<fst::StdVectorFst > >;
