// tiedbin/tied-diag-gmm-decode-faster.cc

// Copyright
//   2009-2011  Microsoft Corporation
...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "Usage:  tied-diag-gmm-decode-faster [options] <model-in> <fst-in> <features-rspecifier> <words-wspecifier> [alignments-wspecifier]\n";
