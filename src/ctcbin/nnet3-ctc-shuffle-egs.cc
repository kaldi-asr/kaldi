// ctcbin/nnet3-ctc-shuffle-egs.cc
...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Copy nnet3+ctc examples for neural network training, from the input to output,\n"
        ...
        "\n"
        "Usage:  nnet3-ctc-shuffle-egs [options] <egs-rspecifier> <egs-wspecifier>\n"
        "\n"
        "nnet3-ctc-shuffle-egs --srand=1 ark:train.egs ark:shuffled.egs\n";
