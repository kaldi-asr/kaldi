// nnetbin/nnet-train-perutt-tgtmat.cc

// Copyright 2011-2014  Brno University of Technology (Author: Karel Vesely)
//                2018  CereProc Ltd. (author: Blaise Potard)
    ...
    for ( ; !feature_reader.Done(); feature_reader.Next()) {
      ...
      // correct small length mismatch ... or drop sentence
      {
        ...
        if (max - min < length_tolerance) {
          ...
          KALDI_WARN << utt << ", length mismatch of targets " << tgt_mat.NumRows()
      ...
      out_nnet_transf.Feedforward(CuMatrix<BaseFloat>(tgt_mat), &nnet_tgt);
      // forward pass
