...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "it out.\n"
        "\n"
        "Usage:  nnet3-compute-from-degs [options] <raw-nnet-in> <training-examples-in> <matrices-out>\n"
        "e.g.:\n"
        "nnet3-compute-from-degs --apply-exp=true 0.raw ark:1.degs ark:- | matrix-sum-rows ark:- ... \n"
