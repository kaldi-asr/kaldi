...
// Copyright 2009-2011  Arnab Ghoshal (Saarland University),  Microsoft Corporation,  Lukas Burget
...
#ifndef KALDI_DECODER_DECODABLE_AM_SGMM_H_
#define KALDI_DECODER_DECODABLE_AM_SGMM_H_
