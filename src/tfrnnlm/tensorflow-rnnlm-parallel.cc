...
void TfRnnlmDeterministicFstParallel::StackTensor(const std::vector<tensorflow::Input> &input_tensor_vector,
...
void TfRnnlmDeterministicFstParallel::UnstackTensor(int size,
